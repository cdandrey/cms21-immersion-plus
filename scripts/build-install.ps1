...
$releaseResourceFiles = @(
    "BrandLogos/AC.png",
    "BrandLogos/AlfaRomeo.png",
    "BrandLogos/Audi.png",
    "BrandLogos/Bugatti.png",
    "BrandLogos/Buick.png",
    "BrandLogos/Cadillac.png",
    "BrandLogos/Checker.png",
    "BrandLogos/Chevrolet.png",
    "BrandLogos/Chrysler.png",
    "BrandLogos/Dacia.png",
    "BrandLogos/Dodge.png",
    "BrandLogos/Dongfeng.png",
    "BrandLogos/Duesenberg.png",
    "BrandLogos/FactoryFive.png",
    "BrandLogos/Ferrari.png",
    "BrandLogos/Fiat.png",
    "BrandLogos/FiatLegacy.png",
    "BrandLogos/FordLegacy.png",
    "BrandLogos/GMC.png",
    "BrandLogos/Holden.png",
    "BrandLogos/Honda.png",
    "BrandLogos/Hongqi.png",
    "BrandLogos/HotWheels.png",
    "BrandLogos/Hudson.png",
    "BrandLogos/Hyundai.png",
    "BrandLogos/Italdesign.png",
    "BrandLogos/Jeep.png",
    "BrandLogos/Koenigsegg.png",
    "BrandLogos/LTI.png",
    "BrandLogos/Lamborghini.png",
    "BrandLogos/Lincoln.png",
    "BrandLogos/McLaren.png",
    "BrandLogos/Mercury.png",
    "BrandLogos/Minecraft.png",
    "BrandLogos/Mini.png",
    "BrandLogos/Mitsubishi.png",
    "BrandLogos/Oldsmobile.png",
    "BrandLogos/Opel.png",
    "BrandLogos/Peugeot.png",
    "BrandLogos/Plymouth.png",
    "BrandLogos/Pontiac.png",
    "BrandLogos/Porsche.png",
    "BrandLogos/Rayfield.png",
    "BrandLogos/Renault.png",
    "BrandLogos/Scion.png",
    "BrandLogos/Shelby.png",
    "BrandLogos/Skoda.png",
    "BrandLogos/Subaru.png",
    "BrandLogos/Suzuki.png",
    "BrandLogos/Tesla.png",
    "BrandLogos/Toyota.png",
    "BrandLogos/VUHL.png",
    "BrandLogos/Volkswagen.png",
    "BrandLogos/Volvo.png",
